...
library SubnetValidatorMessages {
    ...
    {
        require(input.length == 37, "SubnetValidatorMessages: Invalid message length");
        ...
        require(
            ...
            "SubnetValidatorMessages: Invalid message type"
        );
    ...
    {
        require(input.length == 52, "SubnetValidatorMessages: Invalid message length");
    ...
    {
        require(input.length == 44, "SubnetValidatorMessages: Invalid message length");
        ...
        require(
            typeID == VALIDATION_UPTIME_MESSAGE_TYPE_ID,
            "SubnetValidatorMessages: Invalid message type"
        );
    ...
    {
        require(
            validationInfo.signature.length == 64,
            "SubnetValidatorMessages: Invalid signature length"
        );
