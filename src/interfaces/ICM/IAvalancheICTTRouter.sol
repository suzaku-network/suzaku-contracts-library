...
interface IAvalancheICTTRouter {
     ...
     * @param primaryRelayerFee Amount of tokens to pay as the optional relayer fee
     * @param secondaryRelayerFee Amount of tokens to pay for relayer fee if a multi-hop is needed
     */
    event BridgeERC20(
        address indexed tokenAddress,
