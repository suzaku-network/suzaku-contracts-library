...
contract BalancerValidatorManagerTest is Test {
    ...
    modifier validatorRegistrationInitialized() {
        ...
        validatorManager.initiateValidatorRegistrationWithSecurityModule(
    ...
    modifier validatorRegistrationCompleted() {
        ...
        validatorManager.completeValidatorRegistrationWithSecurityModule(
    ...
    function testInitializeValidatorRegistration() public validatorSetInitialized {
        ...
        bytes32 validationID = validatorManager.initiateValidatorRegistrationWithSecurityModule(
            nodeID,
            blsPublicKey,
        ...
        validatorRegistrationCompleted
    {
        ...
        vm.prank(testSecurityModules[0]);
        validatorManager.initiateValidatorWeightUpdateWithSecurityModule(VALIDATION_ID_01, 40);
        ...
        validatorRegistrationCompleted
    {
        ...
        validatorManager.initiateValidatorWeightUpdateWithSecurityModule(VALIDATION_ID_01, 50);
    }
        ...
        validatorRegistrationCompleted
    {
        ...
        validatorManager.completeValidatorWeightUpdateWithSecurityModule(
    ...
    {
        vm.prank(testSecurityModules[0]);
        validatorManager.initiateValidatorRemovalWithSecurityModule(VALIDATION_ID_01);
        ...
        validatorRegistrationCompleted
    {
        ...
        validatorManager.initiateValidatorRemovalWithSecurityModule(VALIDATION_ID_01);
        validatorManager.completeValidatorRemovalWithSecurityModule(VALIDATOR_REGISTRATION_EXPIRED_MESSAGE_INDEX);
